...
public:
	...
	bool hasDeviceFinalHashes() const override;
	const void* getFinalHashMemory(size_t jobId) const override;
	uint8_t* ensureHostKeyBuffer(size_t bytes) override;
	...
	float getLastGpuFinalizeMs() const override;
